...
const Teachers = () => (
    <Page title="Le Capriccio Français i els ensenyants de l’Acadèmia">
        <Lead>
            ...
            <p>
                Le Capriccio Français alterna produccions de gran envergadura (Passió segons Sant
                Joan de J.S. Bach, Israel en Egipte de Händel) i produccions més intimistes. Després
                de{" "}
            ...
            <p>
                ...
                convidat nombrosos artistes (Gérad Lesne, Maarten Koningsberger, Andréas Scholl) a
